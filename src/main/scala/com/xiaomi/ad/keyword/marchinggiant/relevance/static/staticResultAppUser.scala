...
object staticResultAppUser {
  ...
  def excute(input_p:Args, spark_conf: SparkConf): Unit = {
    ...
    val appPath = "/user/h_miui_ad/develop/liguoyu1/project/AppExtension/AppSimInput/appAdInfoCate_"+input_p("yestoday")
    val userPath = "/user/h_miui_ad/develop/liguoyu1/project/AppExtension/UserInput/userCateInfo_"+input_p("yestoday")
    val resultPath = "/user/h_miui_ad/develop/liguoyu1/project/AppExtension/Result/re_sim_user2appid_"+input_p("yestoday")
